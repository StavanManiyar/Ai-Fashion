-- Sample color palette data for the AI Fashion system
-- This script populates the colors table with color recommendations for different Monk skin tones
...
CREATE TABLE IF NOT EXISTS colors (
    ...
    seasonal_palette VARCHAR(100),
    category VARCHAR(50) CHECK (category IN ('recommended', 'avoid', 'neutral')),
...
('#808000', 'Olive', 'Monk01', 'Light Spring', 'avoid');
...
CREATE INDEX IF NOT EXISTS idx_colors_suitable_skin_tone ON colors(suitable_skin_tone);
CREATE INDEX IF NOT EXISTS idx_colors_seasonal_palette ON colors(seasonal_palette);
...
-- Add some additional general colors that work for multiple skin tones
INSERT INTO colors (hex_code, color_name, suitable_skin_tone, seasonal_palette, category) VALUES
-- Universal colors
('#000000', 'Black', NULL, 'Universal', 'recommended'),
('#FFFFFF', 'White', NULL, 'Universal', 'recommended'),
('#808080', 'Gray', NULL, 'Universal', 'recommended'),
('#000080', 'Navy Blue', NULL, 'Universal', 'recommended'),
('#008000', 'Green', NULL, 'Universal', 'recommended'),
('#800020', 'Burgundy', NULL, 'Universal', 'recommended'),
('#36454F', 'Charcoal Gray', NULL, 'Universal', 'recommended'),
('#F5F5DC', 'Cream White', NULL, 'Universal', 'recommended');
